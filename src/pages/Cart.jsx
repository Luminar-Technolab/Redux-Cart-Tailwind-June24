      ...
      <div style={{paddingTop:'100px'}} className='container px-4 mx-auto'>
       {
        ...
        <>
          ...
          <div className="col-span-1  ">
            {/* checkout */}
            <div className='border rounded shadow px-10 p-5'>
        ...
        <div className='flex flex-col justify-center items-center'>
          <img className='w-100 h-1/2' src="https://www.adanione.com/~/media/Foundation/Adani/emptyImages/empty_cart.gif" alt="empty cart" />
